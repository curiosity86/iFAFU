...
class MenuMaker(private val menu: Map<String, List<Menu>>) {
    ...
    fun menuClickListener(listener: OnMenuItemClickListener): MenuMaker {
    ...
    private fun getMenuItem(item: Menu, listener: OnMenuItemClickListener): View {
        //Tab根布局
