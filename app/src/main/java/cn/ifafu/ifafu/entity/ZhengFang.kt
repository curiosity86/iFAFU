...
class ZhengFang(private val schoolCode: String, private val baseUrl: String, private val login: String, private val verify: String, private val main: String, private val apiMap: Map<String, ZFApi>) {
